...
echo "INSECURE=$INSECURE,INSECURE_REGISTRY=$INSECURE_REGISTRY,VIRTUAL_SETUP=$VIRTUAL_SETUP, TAG=$TAG, COMMAND_SERVER_IP=$COMMAND_SERVER_IP, PROVISION=$PROVISION, IMPORT=$IMPORT, C_FILE=$COMMAND_SERVERS_FILE, I_FILE=$INSTANCES_FILE"
